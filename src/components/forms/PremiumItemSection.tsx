      ...
      {isRegistered && (
        <div className="space-y-4 p-4 border border-primary/20 rounded-lg bg-primary/5">
          <div className="flex items-center space-x-2">
            ...
            <Label className="font-medium text-primary">Authenticity Documents</Label>
          </div>

          <p className="text-sm text-muted-foreground">
            Upload authenticity certificates, brand documentation, or warranty papers.
          ...
          {registrationDocs.length > 0 && (
            <div className="mt-4 p-3 bg-card rounded border">
              <p className="text-sm font-medium mb-2">Uploaded Authenticity Documents:</p>
