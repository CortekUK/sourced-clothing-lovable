  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className={`max-w-[58rem] max-h-[90vh] overflow-y-auto ${soldInfo ? 'border-destructive/50' : ''}`}>
          <DialogHeader className={soldInfo ? 'pt-2' : ''}>
            {soldInfo && (
              <div className="mb-4 p-4 bg-destructive/10 border border-destructive/30 rounded-lg mr-8">
                  ...
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-muted-foreground font-sans">
                        ...
                        {(product as any).barcode && <span> • Barcode: {(product as any).barcode}</span>}
                      </p>
                    </div>
              ...
              <AccordionContent className="pb-4">
                <div className="grid grid-cols-2 gap-4 pt-2">
                  ...
                  {(product as any).barcode && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground font-sans">Barcode:</span>
                      <span className="font-medium font-mono">{(product as any).barcode}</span>
                    </div>
                  )}
                  <div className="flex justify-between">
                  ...
                  {product.metal && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground font-sans">Fabric:</span>
                  ...
                  {product.gemstone && (
                    <div className="flex justify-between">
                      <span className="text-muted-foreground font-sans">Color:</span>
