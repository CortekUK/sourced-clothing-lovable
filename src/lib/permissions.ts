...
export const PERMISSION_MATRIX: PermissionMatrix = {
  ...
  manager: {
    ...
    consignments: { view: true, create: true, edit: true, delete: true },
    expenses: { view: true, create: true, edit: true, delete: true },
    reports: { view: false }, // Managers cannot view company P&L reports
    analytics: { view: false }, // Managers cannot view company analytics
    settings: { view: false },
...
export const ROLE_DESCRIPTIONS: Record<UserRole, string> = {
  ...
  manager: 'Full access to operations. Cannot view company financials, reports, or manage users.',
