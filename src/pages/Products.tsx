  ...
  return (
    <Card className="shadow-card hover:shadow-elegant transition-all duration-300 h-full flex flex-col">
      ...
      <CardContent className="flex-1 flex flex-col">
        ...
        {/* Fabric/Size/Color Info */}
        {(product.metal || product.karat || product.gemstone) && (
          <div className="text-xs text-muted-foreground mb-4">
            {product.metal && product.metal}
            {product.karat && ` • Size ${product.karat}`}
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {canCreate(CRM_MODULES.PRODUCTS) && (
              <Button variant="premium" onClick={() => setShowAddProduct(true)} className="whitespace-nowrap">
