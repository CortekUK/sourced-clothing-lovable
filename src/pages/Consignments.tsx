        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="w-full grid grid-cols-3 h-auto">
            <TabsTrigger value="active" className="text-xs sm:text-sm py-2">
              <span className="hidden sm:inline">Active Stock</span>
              <span className="sm:hidden">Active</span>
            </TabsTrigger>
            <TabsTrigger value="sold_unsettled" className="text-xs sm:text-sm py-2">
            ...
            <TabsTrigger value="settled" className="text-xs sm:text-sm py-2">Settled</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="active" className="space-y-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-4">
              ...
              <Button variant="outline" size="sm" onClick={handleExportActiveStock} className="w-full sm:w-auto">
          ...
          <TabsContent value="sold_unsettled" className="space-y-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-4">
              ...
              <Button variant="outline" size="sm" onClick={handleExportUnsettled} className="w-full sm:w-auto">
                <Download className="h-4 w-4 mr-2" />
                Export CSV
              </Button>
            </div>
          ...
          <TabsContent value="settled" className="space-y-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 mb-4">
              ...
              <Button variant="outline" size="sm" onClick={handleExportSettled} className="w-full sm:w-auto">
                <Download className="h-4 w-4 mr-2" />
                Export CSV
              </Button>
            </div>
