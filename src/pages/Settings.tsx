...
export default function Settings() {
  ...
  const availablePresets = [
    { id: 'shirts', label: 'Shirts', category: 'Categories' },
    { id: 'pants', label: 'Pants', category: 'Categories' },
    { id: 'dresses', label: 'Dresses', category: 'Categories' },
    { id: 'jackets', label: 'Jackets', category: 'Categories' },
    { id: 'accessories', label: 'Accessories', category: 'Categories' },
    { id: 'cotton', label: 'Cotton', category: 'Fabrics' },
    { id: 'silk', label: 'Silk', category: 'Fabrics' },
    { id: 'wool', label: 'Wool', category: 'Fabrics' },
    { id: 'denim', label: 'Denim', category: 'Fabrics' },
    { id: 'leather', label: 'Leather', category: 'Fabrics' },
    { id: 'in-stock', label: 'In Stock', category: 'Stock' },
    { id: 'at-risk', label: 'At Risk', category: 'Stock' },
    { id: 'out-of-stock', label: 'Out of Stock', category: 'Stock' },
    { id: 'under-50', label: '< £50', category: 'Price' },
    { id: '50-100', label: '£50–£100', category: 'Price' },
    { id: '100-500', label: '£100–£500', category: 'Price' },
    { id: 'over-500', label: '> £500', category: 'Price' },
  ];
                ...
                <div className="pt-4 border-t">
                  <div className="flex gap-2 flex-wrap">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handleSettingChange('quickFilterPresets', ['shirts', 'pants', 'dresses', 'cotton', 'silk', 'in-stock', 'at-risk'])}
                      disabled={settingsLoading || userRole !== 'owner'}
                    >
                      Reset to Defaults
                    </Button>
