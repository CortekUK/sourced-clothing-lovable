      ...
      <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 sm:grid-cols-5 h-auto gap-1">
            ...
            <TabsTrigger value="suppliers" className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm py-2">
                ...
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-base sm:text-lg">Product Performance</span>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
                ...
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-base sm:text-lg">Supplier Analysis</span>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
                ...
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-base sm:text-lg">System Activity</span>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
                ...
                <CardHeader className="p-4 sm:p-6">
                  <CardTitle className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-base sm:text-lg">Business Health</span>
                    </div>
                    <Button
                      variant="ghost"
                      size="sm"
